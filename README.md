...
Project Goals
This research focused on protecting user privacy on smartphones by implementing a hybrid encryption system. I prioritized Confidentiality and Integrity using the AES-GCM (Galois/Counter Mode) authenticated encryption.

Why AES-GCM?
During my research, I evaluated multiple modes of operation. I chose GCM because:
